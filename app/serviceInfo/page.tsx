        ...
        <div className="space-y-24">
            ...
            <div className="sm:col-span-12 md:col-span-7">
                ...
                <div>
                    ...
                    <p>1245346540</p>
                    <button type="button" className="font-medium text-indigo-600 hover:text-indigo-500">Edit</button>
                    </dd>
                </div>
                </dl>
                <p className="mt-6 font-medium text-gray-900 md:mt-10">Procesado el <time dateTime="2024-05-24">Mayo 24, 2024</time></p>
                <div className="mt-6">
