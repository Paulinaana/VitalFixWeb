...
function page() {
  return (
    <div>
        ...
        <a href="#" className="text-2xl font-bold text-gray-800">VitalFix</a>
        <div className="mt-4 py-2 text-xs sm:mt-0 sm:ml-auto sm:text-base">
            ...
            <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                ...
                <span className="font-semibold text-gray-500">Pagado</span>
                </li>
            </ul>
            </div>
        </div>
        ...
        <div className="px-4 pt-8">
            ...
            <p className="text-gray-400">Compruebe sus equipos. Y seleccione un método de pago adecuado.</p>
            <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="/monitor.jpg" alt="" />
                <div className="flex w-full flex-col px-4 py-4">
                <span className="font-semibold">Monitor de Paciente</span>
                <p className="text-lg font-bold">$50.00</p>
                </div>
            </div>
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src="/ultrasonido.jpg" alt="" />
                <div className="flex w-full flex-col px-4 py-4">
                <span className="font-semibold">Ultrasonido</span>
                <p className="text-lg font-bold">$100.00</p>
                </div>
            </div>
            </div>

            <p className="mt-8 text-lg font-medium">Métodos de Pago</p>
            ...
            <div className="relative">
                ...
                <div className="ml-5">
                    <span className="mt-2 font-semibold">Transferencia Bancaria</span>
                    <p className="text-slate-500 text-sm leading-6">Bancamiga</p>
                </div>
                </label>
            </div>
            <div className="relative">
                ...
                <div className="ml-5">
                    <span className="mt-2 font-semibold">Pago Móvil</span>
                    <p className="text-slate-500 text-sm leading-6">Banco</p>
                </div>
                </label>
            </div>
            </form>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div className="mt-6 border-t border-b py-2">
                ...
                <p className="font-semibold text-gray-900">$15.00</p>
                </div>
            </div>
            <div className="mt-6 flex items-center justify-between">
                <p className="text-sm font-medium text-gray-900">Total</p>
                <p className="text-2xl font-semibold text-gray-900">$165.00</p>
            </div>
            </div>
            <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Finalizar Pedido</button>
        </div>
        </div>
